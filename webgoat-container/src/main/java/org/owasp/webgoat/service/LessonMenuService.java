...
public class LessonMenuService {
	...
	@ResponseBody
	public List<LessonMenuItem> showLeftNav() {
	...
	public LessonMenuService(final Course course, final WebSession webSession, final UserTrackerRepository userTrackerRepository, final List<String> excludeCategories, final List<String> excludeLessons) {
		this.course = course;
