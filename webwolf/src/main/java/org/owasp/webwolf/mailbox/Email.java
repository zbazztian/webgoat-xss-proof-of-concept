...
public class Email implements Serializable {
    ...
    public static class EmailBuilder {
         ...
         * @return {@code this}.
         */
        public Email.EmailBuilder id(final Long id) {
            this.id = id;
            return this;
        }
    ...
    public Email(final Long id, final LocalDateTime time, final String contents, final String sender, final String title, final String recipient) {
        this.id = id;
        this.time = time;
        this.contents = contents;
        this.sender = sender;
